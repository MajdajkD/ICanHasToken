...
namespace ICH.Solidity.Contracts.ICHBurnMintERC20
{
    public partial class ICHBurnMintERC20Service
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, ICHBurnMintERC20Deployment iCHBurnMintERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ICHBurnMintERC20Deployment>().SendRequestAndWaitForReceiptAsync(iCHBurnMintERC20Deployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, ICHBurnMintERC20Deployment iCHBurnMintERC20Deployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ICHBurnMintERC20Deployment>().SendRequestAsync(iCHBurnMintERC20Deployment);
        }

        public static async Task<ICHBurnMintERC20Service> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, ICHBurnMintERC20Deployment iCHBurnMintERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, iCHBurnMintERC20Deployment, cancellationTokenSource);
            return new ICHBurnMintERC20Service(web3, receipt.ContractAddress);
        }
        ...
        public ICHBurnMintERC20Service(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;

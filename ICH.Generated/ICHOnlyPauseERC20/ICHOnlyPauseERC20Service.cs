...
namespace ICH.Solidity.Contracts.ICHOnlyPauseERC20
{
    public partial class ICHOnlyPauseERC20Service
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, ICHOnlyPauseERC20Deployment iCHOnlyPauseERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ICHOnlyPauseERC20Deployment>().SendRequestAndWaitForReceiptAsync(iCHOnlyPauseERC20Deployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, ICHOnlyPauseERC20Deployment iCHOnlyPauseERC20Deployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ICHOnlyPauseERC20Deployment>().SendRequestAsync(iCHOnlyPauseERC20Deployment);
        }

        public static async Task<ICHOnlyPauseERC20Service> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, ICHOnlyPauseERC20Deployment iCHOnlyPauseERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, iCHOnlyPauseERC20Deployment, cancellationTokenSource);
            return new ICHOnlyPauseERC20Service(web3, receipt.ContractAddress);
        }
        ...
        public ICHOnlyPauseERC20Service(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;

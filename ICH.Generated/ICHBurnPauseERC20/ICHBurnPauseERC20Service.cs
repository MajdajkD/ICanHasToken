...
namespace ICH.Solidity.Contracts.ICHBurnPauseERC20
{
    public partial class ICHBurnPauseERC20Service
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, ICHBurnPauseERC20Deployment iCHBurnPauseERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ICHBurnPauseERC20Deployment>().SendRequestAndWaitForReceiptAsync(iCHBurnPauseERC20Deployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, ICHBurnPauseERC20Deployment iCHBurnPauseERC20Deployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ICHBurnPauseERC20Deployment>().SendRequestAsync(iCHBurnPauseERC20Deployment);
        }

        public static async Task<ICHBurnPauseERC20Service> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, ICHBurnPauseERC20Deployment iCHBurnPauseERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, iCHBurnPauseERC20Deployment, cancellationTokenSource);
            return new ICHBurnPauseERC20Service(web3, receipt.ContractAddress);
        }
        ...
        public ICHBurnPauseERC20Service(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;

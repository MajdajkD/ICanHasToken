...
namespace ICH.Solidity.Contracts.ICHOnlyMintERC20
{
    public partial class ICHOnlyMintERC20Service
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, ICHOnlyMintERC20Deployment iCHOnlyMintERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ICHOnlyMintERC20Deployment>().SendRequestAndWaitForReceiptAsync(iCHOnlyMintERC20Deployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, ICHOnlyMintERC20Deployment iCHOnlyMintERC20Deployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ICHOnlyMintERC20Deployment>().SendRequestAsync(iCHOnlyMintERC20Deployment);
        }

        public static async Task<ICHOnlyMintERC20Service> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, ICHOnlyMintERC20Deployment iCHOnlyMintERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, iCHOnlyMintERC20Deployment, cancellationTokenSource);
            return new ICHOnlyMintERC20Service(web3, receipt.ContractAddress);
        }
        ...
        public ICHOnlyMintERC20Service(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;

...
namespace ICH.Solidity.Contracts.ICHOnlyBurnERC20
{
    public partial class ICHOnlyBurnERC20Service
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, ICHOnlyBurnERC20Deployment iCHOnlyBurnERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ICHOnlyBurnERC20Deployment>().SendRequestAndWaitForReceiptAsync(iCHOnlyBurnERC20Deployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, ICHOnlyBurnERC20Deployment iCHOnlyBurnERC20Deployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ICHOnlyBurnERC20Deployment>().SendRequestAsync(iCHOnlyBurnERC20Deployment);
        }

        public static async Task<ICHOnlyBurnERC20Service> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, ICHOnlyBurnERC20Deployment iCHOnlyBurnERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, iCHOnlyBurnERC20Deployment, cancellationTokenSource);
            return new ICHOnlyBurnERC20Service(web3, receipt.ContractAddress);
        }
        ...
        public ICHOnlyBurnERC20Service(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;

...
using ICH.Solidity.Contracts.ICHBurnMintPauseCapERC20.ContractDefinition;

namespace ICH.Solidity.Contracts.ICHBurnMintPauseCapERC20
{
    public partial class ICHBurnMintPauseCapERC20Service
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, ICHBurnMintPauseCapERC20Deployment iCHBurnMintPauseCapERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ICHBurnMintPauseCapERC20Deployment>().SendRequestAndWaitForReceiptAsync(iCHBurnMintPauseCapERC20Deployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, ICHBurnMintPauseCapERC20Deployment iCHBurnMintPauseCapERC20Deployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ICHBurnMintPauseCapERC20Deployment>().SendRequestAsync(iCHBurnMintPauseCapERC20Deployment);
        }

        public static async Task<ICHBurnMintPauseCapERC20Service> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, ICHBurnMintPauseCapERC20Deployment iCHBurnMintPauseCapERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, iCHBurnMintPauseCapERC20Deployment, cancellationTokenSource);
            return new ICHBurnMintPauseCapERC20Service(web3, receipt.ContractAddress);
        }
        ...
        public ICHBurnMintPauseCapERC20Service(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;

...
namespace ICH.Solidity.Contracts.ICHBurnMintPauseERC20
{
    public partial class ICHBurnMintPauseERC20Service
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, ICHBurnMintPauseERC20Deployment iCHBurnMintPauseERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ICHBurnMintPauseERC20Deployment>().SendRequestAndWaitForReceiptAsync(iCHBurnMintPauseERC20Deployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, ICHBurnMintPauseERC20Deployment iCHBurnMintPauseERC20Deployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ICHBurnMintPauseERC20Deployment>().SendRequestAsync(iCHBurnMintPauseERC20Deployment);
        }

        public static async Task<ICHBurnMintPauseERC20Service> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, ICHBurnMintPauseERC20Deployment iCHBurnMintPauseERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, iCHBurnMintPauseERC20Deployment, cancellationTokenSource);
            return new ICHBurnMintPauseERC20Service(web3, receipt.ContractAddress);
        }
        ...
        public ICHBurnMintPauseERC20Service(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;

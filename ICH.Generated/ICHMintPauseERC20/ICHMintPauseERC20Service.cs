...
namespace ICH.Solidity.Contracts.ICHMintPauseERC20
{
    public partial class ICHMintPauseERC20Service
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, ICHMintPauseERC20Deployment iCHMintPauseERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ICHMintPauseERC20Deployment>().SendRequestAndWaitForReceiptAsync(iCHMintPauseERC20Deployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, ICHMintPauseERC20Deployment iCHMintPauseERC20Deployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ICHMintPauseERC20Deployment>().SendRequestAsync(iCHMintPauseERC20Deployment);
        }

        public static async Task<ICHMintPauseERC20Service> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, ICHMintPauseERC20Deployment iCHMintPauseERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, iCHMintPauseERC20Deployment, cancellationTokenSource);
            return new ICHMintPauseERC20Service(web3, receipt.ContractAddress);
        }
        ...
        public ICHMintPauseERC20Service(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;

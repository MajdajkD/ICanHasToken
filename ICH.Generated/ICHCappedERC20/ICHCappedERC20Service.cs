using ICH.Solidity.Contracts.ICHCappedERC20.ContractDefinition;
...
namespace ICH.Solidity.Contracts.ICHCappedERC20
{
  public partial class ICHCappedERC20Service
  {
    public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, ICHCappedERC20Deployment iCHCappedERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
    {
      return web3.Eth.GetContractDeploymentHandler<ICHCappedERC20Deployment>().SendRequestAndWaitForReceiptAsync(iCHCappedERC20Deployment, cancellationTokenSource);
    }

    public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, ICHCappedERC20Deployment iCHCappedERC20Deployment)
    {
      return web3.Eth.GetContractDeploymentHandler<ICHCappedERC20Deployment>().SendRequestAsync(iCHCappedERC20Deployment);
    }

    public static async Task<ICHCappedERC20Service> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, ICHCappedERC20Deployment iCHCappedERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
    {
      var receipt = await DeployContractAndWaitForReceiptAsync(web3, iCHCappedERC20Deployment, cancellationTokenSource);
      return new ICHCappedERC20Service(web3, receipt.ContractAddress);
    }
    ...
    public ICHCappedERC20Service(Nethereum.Web3.Web3 web3, string contractAddress)
    {
      Web3 = web3;
